...
if (isset($_POST['arrival'], $_POST['departure'], $_POST['first_name'], $_POST['last_name'], $_POST['email'], $_POST['phone'], $_POST['adults'], $_POST['children'])) {
    // Process form data
    ...
    if (!$responses) {
        ...
        $to      = 'florind.dev@gmail.com';
        // Mail from
        $from    = 'florind1587@gmail.com';
        // Mail subject
  ...
  <body>
    <form class="hotel-reservation-form" method="post" action="">
      ...
      <div class="fields">
        ...
        <div class="wrapper">
          <div>
            <label for="arrival">Sosore / Arrival</label>
            <div class="field">
          ...
          <div class="gap"></div>
          <div>
            <label for="departure">Plecare / Departure</label>
            <div class="field">
        ...
        <div class="wrapper">
          <div>
            <label for="first_name">Prenume / First Name</label>
            <div class="field">
          ...
          <div class="gap"></div>
          <div>
            <label for="last_name">Nume / Last Name</label>
            <div class="field">
              <i class="fas fa-user"></i>
              <input
                id="last_name"
        ...
        <div class="wrapper">
          <div>
            <label for="adults">Adulti / Adults</label>
            <div class="field">
          ...
          <div class="gap"></div>
          <div>
            <label for="children">Copii / Children</label>
            <div class="field">
